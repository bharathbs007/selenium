	...
	public static void startTesting(String filename,String testStartTime,String env,String rel)
	  {
	    ...
	    out.write("<html>\n");
	    out.write("<HEAD>\n");
	    out.write(" <TITLE>ICF Automation Test Results by QA Team</TITLE>\n");
	     out.write("</HEAD>\n");
	    ...
	    out.write("<td width=150 align=left><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75> <img src='icf_logo.png' align=right></img></td>\n"); 
	     ...
	     out.write("<h1 align=center><FONT COLOR=FF4500 FACE=AriaL SIZE=7><b>ITC Automation Report</b></h1>\n");
	     ...
	     //      out.write("<h4> <FONT COLOR=black FACE=Arial SIZE=4.5> <u>Test Details :</u></h4>\n");
	           out.write("<td width=150 align=left bgcolor=><FONT COLOR=#080E25 FACE=Arial SIZE=2.75><b>Run Date</b></td>\n");
	           out.write("<td width=150 align=left><FONT COLOR=black FACE=Arial SIZE=2.75><b>"+RUN_DATE+"</b></td>\n");
	     out.write("</tr>\n");
	     out.write("<tr>\n");
	           
	           out.write("<td width=150 align=left bgcolor=><FONT COLOR=black FACE=Arial SIZE=2.75><b>Run StartTime</b></td>\n");

	           out.write("<td width=150 align=left><FONT COLOR=black FACE=Arial SIZE=2.75><b>"+testStartTime+"</b></td>\n");
	     out.write("</tr>\n");
	     out.write("<tr>\n");
	    // out.newLine();   
	           out.write("<td width=150 align= left  bgcolor=><FONT COLOR=black FACE= Arial  SIZE=2.75><b>Run EndTime</b></td>\n");
	           out.write("<td width=150 align= left ><FONT COLOR=black FACE= Arial  SIZE=2.75><b>END_TIME</b></td>\n");
	     out.write("</tr>\n");
	     out.write("<tr>\n");
	   //  out.newLine();
	           
	           out.write("<td width=150 align= left  bgcolor=><FONT COLOR=black FACE= Arial  SIZE=2.75><b>Environment</b></td>\n");
	           out.write("<td width=150 align= left ><FONT COLOR=black FACE= Arial  SIZE=2.75><b>"+ENVIRONMENT+"</b></td>\n");
	     out.write("</tr>\n");
	     out.write("<tr>\n");
	           
	           out.write("<td width=150 align= left  bgcolor=><FONT COLOR=black FACE= Arial  SIZE=2.75><b>Release</b></td>\n");
		   ...
		   if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")){
			...
			out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> Detailed Report :</h4>");
		 	 ...
		 	 out.write("<tr> ");
		        ...
		        out.write("<td align=center width=50% align=center bgcolor=red><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2><b><p align=left>Description</p> Description</b></td>");
		 	 ...
		 	 if(description!=null){
				 int count =0;
		 		 for(int i=0;i<description.size();i++){
					 if(!keyword.get(i).equalsIgnoreCase("waitfor"))
					 {
						 count++;
						 	 out.write("<tr> ");

		 			 out.write("<td align=center width=10%><FONT COLOR=black FACE=Arial SIZE=1><b>TS"+(count)+"</b></td>");
		 			 out.write("<td align=center width=50%><FONT COLOR=black FACE=Arial SIZE=1><b>"+description.get(i)+"<p align=left>Description</p></b></td>");
			...
			// out.newLine();
			 ...
			 {
				 currentDir =  currentDir.replaceFirst("//","~~").replaceAll("//","/").replaceAll("~~","//");
				 out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"/"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverApp.year+"_"+DriverApp.date+"_"+(DriverApp.month+1)+"_"+DriverApp.day+"_"+DriverApp.min+"_" +DriverApp.sec+".html>"+testCaseName+"</a></b></td>\n");
			 }
